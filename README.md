## kobuki_velocity_smoother (humble) - 0.15.1-1

The packages in the `kobuki_velocity_smoother` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble kobuki_velocity_smoother` on `Tue, 24 Feb 2026 19:34:17 -0000`
...
## kobuki_velocity_smoother (jazzy) - 0.15.1-1

The packages in the `kobuki_velocity_smoother` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy kobuki_velocity_smoother` on `Tue, 24 Feb 2026 19:32:51 -0000`
...
## kobuki_velocity_smoother (kilted) - 0.15.1-1

The packages in the `kobuki_velocity_smoother` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --track kilted --rosdistro kilted kobuki_velocity_smoother` on `Tue, 24 Feb 2026 19:31:29 -0000`
